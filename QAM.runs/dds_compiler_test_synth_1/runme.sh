...
HD_PWD='D:/Users/alexa/Documents/GitHub/QAM/QAM.runs/dds_compiler_test_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_compiler_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_compiler_test.tcl
