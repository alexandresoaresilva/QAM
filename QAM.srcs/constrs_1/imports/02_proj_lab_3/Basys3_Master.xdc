...
#create_clock -period 10.00 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports CLK]

#create_generated_clock -name sys_clk_pin -source W5 -multiply_by 4 -add [get_ports CLK]
...
#set_property BITSTREAM.CONFIG.CONFIGRATE 33 [current_design] #33 MHz conf rate
